...
- DetectionFocused: Blurs the detections on given image 
...
![imagefocused_workflow](https://github.com/user-attachments/assets/d14e38ce-89db-4646-93b6-cf0e8c45601f)
...
| `kernel_size` | int  | Size of the kernel (must be odd) (<52)                     | `25`          |
